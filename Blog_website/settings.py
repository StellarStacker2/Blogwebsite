...
SECRET_KEY = 'django-insecure-s_l1!r#_a)sp%bbsg7#ay^d(-nt0!(wxfgi4!4#q=zk#+k_ggx'
...
ACCOUNT_AUTHENTICATED_LOGIN_REDIRECTS = True  # Allow auto login redirect
...
STATIC_URL = '/static/'  # Change to this line
